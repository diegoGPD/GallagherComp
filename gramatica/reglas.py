...
from gramatica.utils import generateQuad, generateAssignQuad, generateOperationQuad, generateFalseJumpQuad, \
    ...
    foundArrayAccess, arrayExpresionHelper, endArrayAccess, promParameterQuad, restartPromCalled, callPromQuadruple
...
def p_param_table_init(p):
    ...
    if not ('paramsTable' in compilacion.variables.variables['funciones'][
        compilacion.variables.variables['currentFunc']]):
        compilacion.variables.variables['funciones'][compilacion.variables.variables['progName']]['paramsTable'] = {}
...
def p_param_declare_empty(p):
    '''
        param_declare_empty : empty
    '''
    if not bool(compilacion.variables.variables['funciones'][compilacion.variables.variables['currentFunc']]['letsTable']):
        compilacion.variables.variables['funciones'][compilacion.variables.variables['currentFunc']]['emptyParam'] = True
